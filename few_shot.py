class FewShot:
    ...
    def get_examples():
        examples = [
            {
                "email_body": """Hello Everyone my name is Bob and I’m excited to learn more about C++ programming. 
                This is my last class before I complete my degree here at NOVA. I currently work full time at Verizon doing IT support and my major is Cyber Security. 
                ...
                "response": """
                Bob, Welcome to ITP 132.  It is a pleasure to meet you. Looking forward to working with you this fall.  Congrats on being so close to finishing your
            ...
            },
            {
                ...
                4) From this course, I am expecting to be able to write a code and debug it in the C++ language. 
                ...
                """,
                "response": """
                Paula, Great to meet you and welcome to ITP 132.  I am really excited to get started.  This course will definately teach you the fundamentals of 
            ...
            {
                "email_body": """
                My name is Michael and this is not my first online class. I am in my final semester at NOVA in which I plan to 
                transfer to George Mason after. I have worked my entire adult life in healthcare, particularly the Emergency Medical side. 
                My long term goal is to stay in healthcare but work cyber security ensuring patient safety from the IT realm. 
                I expect to learn the basics of C++ and hope that this will peak my interest in coding and allow me to add a new skill to my resume.
                """,
                "response": """
                        Michael,  Its nice to meet you.  Welcome to ITP 132.   I see there is light at the end of the tunnel for you. 
                        Excellent choice in choosing Cyber, and GMU.  Great major and great school. Best of luck this
    ...
    def get_prefix():
        ...
        to always reach out for help if they struggle. It should be in a friendly tone as well.
        """
